    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View>
            <Text style={styles.headerTitle}>Gia sư AI</Text>
            <View style={styles.statusRow}>
              <View style={styles.statusDot} />
              <Text style={styles.headerSub}>Sẵn sàng hỗ trợ bạn</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={0}>
        ...
        {selectedImage && (
          <View style={styles.previewBar}>
            ...
            <View style={styles.previewInfo}>
              ...
              <Text style={styles.previewHint}>Nhập câu hỏi hoặc bấm gửi</Text>
            </View>
        ...
        <View style={styles.inputBar}>
          <TouchableOpacity onPress={showImageOptions} style={styles.imageBtn} disabled={loading}>
          ...
          <TouchableOpacity
            ...
            style={[styles.sendBtn, (!message.trim() && !selectedImage || loading) && { opacity: 0.4 }]}
          >
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    borderBottomWidth: 1, borderBottomColor: '#2A2A4A', backgroundColor: '#0F0F23',
  },
  headerLeft: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  avatarContainer: {
    width: 42, height: 42, borderRadius: 21, backgroundColor: '#6C63FF22',
    justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#6C63FF44',
  },
  avatarText: { fontSize: 20 },
  headerTitle: { fontSize: 20, fontWeight: '800', color: '#FFF' },
  statusRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 2 },
  statusDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#2ED573' },
  headerSub: { fontSize: 12, color: '#8E8EAA' },
  ...
  aiAvatar: {
    width: 30, height: 30, borderRadius: 15, backgroundColor: '#1A1A2E',
  ...
  userBubble: {
    backgroundColor: '#6C63FF', borderBottomRightRadius: 4, marginLeft: 'auto',
  },
  aiBubble: {
    backgroundColor: '#1A1A2E', borderBottomLeftRadius: 4,
    borderWidth: 1, borderColor: '#2A2A4A',
  },
  ...
  typingText: { color: '#8E8EAA', fontSize: 13 },

  // Image preview
  previewBar: {
    flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 10,
    backgroundColor: '#1A1A2E', borderTopWidth: 1, borderTopColor: '#2A2A4A', gap: 12,
  },
  previewImage: { width: 50, height: 50, borderRadius: 10 },
  previewInfo: { flex: 1 },
  previewLabel: { color: '#FFF', fontSize: 13, fontWeight: '600' },
  previewHint: { color: '#8E8EAA', fontSize: 11, marginTop: 2 },
  removeBtn: {
    width: 28, height: 28, borderRadius: 14, backgroundColor: '#FF475733',
    justifyContent: 'center', alignItems: 'center',
  },
  removeText: { color: '#FF4757', fontWeight: '800', fontSize: 14 },

  // Input bar
  inputBar: {
    flexDirection: 'row', alignItems: 'flex-end', paddingHorizontal: 12,
    paddingVertical: 10, borderTopWidth: 1, borderTopColor: '#2A2A4A', backgroundColor: '#0F0F23',
  },
  imageBtn: {
